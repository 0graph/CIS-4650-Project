...
* --- Return Expression ---
25: JEQ 0,4(7) if false jump 4 instructions
* --- Return Expression ---
* --- Calling gcd() ---
* Offset: 7
* Adding argument 1
...
40: LD 0,-12(5) Load Left hand side
41: LD 1,-13(5) Load Right hand side
42: DIV 0,0,1 Operation
43: ST 0,-11(5) Store value of expression
* --- Operation Expression ---
...
50: LD 0,-9(5) Load Left hand side
51: LD 1,-10(5) Load Right hand side
52: SUB 0,0,1 Operation
53: ST 0,-8(5) Store value of expression
* --- Operation Expression ---
...
* Create new activation record
91: ST 5,-4(5) Save address of current frame pointer to memory with offset 12
...
* Create new activation record
98: ST 5,-3(5) Save address of current frame pointer to memory with offset 8
