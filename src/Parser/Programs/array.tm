...
13: LDA 0,-12(5) Load address for var (i)
14: ST 0,-14(5) &i
* Loading Constant 0 to register 0 and save to memory with offset 15
15: LDC 0,0(0) 
16: ST 0,-15(5) 
* Store back the result of the assignment operation
17: LD 0,-14(5) Load to memory the address and result value
18: LD 1,-15(5) 
19: ST 1,0(0) 
20: ST 1,-13(5) Value Stored!
* --- Assignment Expression ---
* --- While Expression ---
* --- Operation Expression ---
21: LD 0,-12(5) Value of i
22: ST 0,-15(5) 
...
25: LD 0,-15(5) Load Left hand side
26: LD 1,-16(5) Load Right hand side
...
32: ST 0,-14(5) Store value of expression
* --- Operation Expression ---
* --- Assignment Expression ---
35: LD 0,-12(5) Value of i
36: ST 0,-17(5) 
...
38: LD 1,-17(5) Load index value to register
39: SUB 0,0,1 Substract the offset to the address
40: ST 0,-16(5) Store the address given the index at offset 16
41: LD 0,-12(5) Value of i
42: ST 0,-17(5) 
* Store back the result of the assignment operation
43: LD 0,-16(5) Load to memory the address and result value
44: LD 1,-17(5) 
45: ST 1,0(0) 
46: ST 1,-15(5) Value Stored!
* --- Assignment Expression ---
* --- Assignment Expression ---
47: LDA 0,-12(5) Load address for var (i)
48: ST 0,-16(5) &i
* --- Operation Expression ---
49: LD 0,-12(5) Value of i
50: ST 0,-18(5) 
...
53: LD 0,-18(5) Load Left hand side
54: LD 1,-19(5) Load Right hand side
55: ADD 0,0,1 Operation
56: ST 0,-17(5) Store value of expression
* --- Operation Expression ---
* Store back the result of the assignment operation
57: LD 0,-16(5) Load to memory the address and result value
58: LD 1,-17(5) 
59: ST 1,0(0) 
60: ST 1,-15(5) Value Stored!
* --- Assignment Expression ---
61: LDA 7,-39(7) Jump to test after body
* Load the test value to register 0
33: LD 0,-14(5) Load test value
34: JLE 0,27(7) Jump to end if test <= 0 (false)
* --- Assignment Expression ---
62: LDA 0,-12(5) Load address for var (i)
63: ST 0,-14(5) &i
* Loading Constant 0 to register 0 and save to memory with offset 15
64: LDC 0,0(0) 
65: ST 0,-15(5) 
* Store back the result of the assignment operation
66: LD 0,-14(5) Load to memory the address and result value
67: LD 1,-15(5) 
68: ST 1,0(0) 
69: ST 1,-13(5) Value Stored!
* --- Assignment Expression ---
* --- While Expression ---
* --- Operation Expression ---
70: LD 0,-12(5) Value of i
71: ST 0,-15(5) 
* Loading Constant 10 to register 0 and save to memory with offset 16
72: LDC 0,10(0) 
73: ST 0,-16(5) 
* Save the result of the operation expression to the address offset 14
74: LD 0,-15(5) Load Left hand side
75: LD 1,-16(5) Load Right hand side
...
81: ST 0,-14(5) Store value of expression
* --- Operation Expression ---
* --- Calling output() ---
* Offset: 15
* Adding argument 1
84: LD 0,-12(5) Value of i
85: ST 0,-17(5) 
* Load index calculated at offset 17 and base address of array x[] and save it to offset 16
86: LDA 0,-2(5) Load address to register
87: LD 1,-17(5) Load index value to register
88: SUB 0,0,1 Substract the offset to the address
89: LD 0,0(0) Load the value at the x[index] address to the AC
90: ST 0,-16(5) Value of x[index]
91: ST 0,-17(5) Storing argument
* Create new activation record
92: ST 5,-15(5) Save address of current frame pointer to memory with offset 15
93: LDA 5,-15(5) Load the frame pointer so that it starts at offset 15
...
97: ST 0,-15(5) Store return value
* --- Calling output() ---
* --- Assignment Expression ---
98: LDA 0,-12(5) Load address for var (i)
99: ST 0,-16(5) &i
* --- Operation Expression ---
100: LD 0,-12(5) Value of i
101: ST 0,-18(5) 
* Loading Constant 1 to register 0 and save to memory with offset 19
102: LDC 0,1(0) 
103: ST 0,-19(5) 
* Save the result of the operation expression to the address offset 17
104: LD 0,-18(5) Load Left hand side
105: LD 1,-19(5) Load Right hand side
106: ADD 0,0,1 Operation
107: ST 0,-17(5) Store value of expression
* --- Operation Expression ---
* Store back the result of the assignment operation
108: LD 0,-16(5) Load to memory the address and result value
109: LD 1,-17(5) 
110: ST 1,0(0) 
111: ST 1,-15(5) Value Stored!
* --- Assignment Expression ---
112: LDA 7,-41(7) Jump to test after body
* Load the test value to register 0
82: LD 0,-14(5) Load test value
