...
public class SymbolErrors {
   ...
   * @param column   The column
   */
  public void addReturnTypeError(String name, Type type, Type expected, Integer row, Integer column) {
    String text = String.format(
        "Warning: Function %s has been declared as type %s. Variable will be updated to type %s", name, type, expected);
